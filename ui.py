def make_table(table):
    ...
    for i in range(columns):
        for j in range(rows):
            columns_rows[i].append(table[j][i])
...
def main():
    table = [['1dsa', 'Janusz Kozlowski', 1922234], ['dakdjhkajhdw', 'Barbra Saasdatreid', 1991122],
             ['dkllk7', 'AlbadasSadasd', 1929929921223], ['dkllk798820', 'AlbadasSasdasadasd', 192992992122322],
             ['dakdjhkajhdw', 'Barbra Saasdatreid', 1991122], ['dakdjhkajhdw', 'Barbra Saasdatreid', 1991122]]
